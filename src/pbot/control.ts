...
function symmetricListTransform(op: OperationBase.Operation, list: Array<OperationBase.Operation>): Array<any> {
  var tOp = op;
  var tList: Array<OperationBase.Operation> = [];
...
class OTClient {
  ...
  private _transformationPathBySiteId:{ [siteId: string]: Deque<OperationBase.Operation> } = {};
  ...
  constructor(
    ...
    private _model: OperationBase.Model
  ) { }
  ...
  public handleLocalOp(op: OperationBase.Operation) {
  ...
  public handleRemoteOp(op: OperationBase.Operation) {
    if (DEBUG) {
      let json = {};
      op.fillJson(json);
    ...
    var l2: Array<OperationBase.Operation> = [];
    ...
    let opOverL1: OperationBase.Operation = null;
    let l1OverOp:Array<OperationBase.Operation> = null;

    let opOverL1L2: OperationBase.Operation = null;
    let l2OverOp:Array<OperationBase.Operation> = null;
    ...
    for (var siteId in this._transformationPathBySiteId) {
      if (siteId === op.timestamp().siteId()) {
        ...
        this._transformationPathBySiteId[siteId] = new Deque<OperationBase.Operation>(l1OverOp.concat(l2OverOp));
        continue;
      }
  ...
  private pathForSiteId(siteId: string): Deque<OperationBase.Operation> {
    if (!(siteId in this._transformationPathBySiteId)) {
      this._transformationPathBySiteId[siteId] = new Deque<OperationBase.Operation>();
    }
