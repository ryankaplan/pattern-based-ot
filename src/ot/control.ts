...
class OTClient {
	_lastRemoteTotalOrderingId: number = null;
	...
	_transformationPathBySiteId: { [siteId: string]: Array<Operation> } = {};
	...
	public handleRemoteOp(op: Operation) {
		...
		this._model.executeOperation(opOverL1L2);
